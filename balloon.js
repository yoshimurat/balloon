...
z	};
	...
	var check_collision = function () {
		for (var i = 0; i < light.length; i++) {
			if (Math.abs(light[i].x - p.x) < 10 && Math.abs(light[i].y - p.y) < 10  && --p.life < 0) break;
		}
		...
		for (var i = 0; i < bal.length; i++) {
			if (Math.abs(bal[i].x-p.x) < D && Math.abs(bal[i].y-p.y) < D) {
				bal[i].active = 0;
				var tmp = 100+200*bal_rank;
				bal_cmb++;
				bal_cnt++;
				if (bal_cmb > 0 && bal_cmb % 20 == 0) {
					tmp = 2000;
					bal_rank++;
				}
				score += tmp;
	...
	var lighttable0= [
"SSLSSBSSSSSLSSSSSLSSWW",
"SSLSSSSSSSSSSSSSSSSSWW",
"SSSLSSSSSSSSSSSLSSSSWW",
"SSSLSSSSSSSSSSSSSSSSWW",
"SSSSLSSSSSSSSSLSSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SBSSSSLSSSSSSSBSSSSSWW",
"SSSSSSSLSSSSSSSSSSSSWW",
"SSSSSSSSLSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSLSSSSWW",
"SLSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSSSBSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSLSSSSSSBSSSSSSWW",
"SSSSSLSSSSSSSSSSSSSSWW",
"SSSSLSSSSSSSSSLSSSSSWW",
"SSBSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSLSSSSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSSLSSSSSSSSSSSSSSWW",
"SSSSSSSSBSSSSSSSSBSSWW",
"SSSLSSSSSBSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSLSSSSSSLSSWW",
"SSSLSSSSSSSSSSSSSSSSWW",
"SSLSLSSSSSSSSSSLSSSSWW",
"SSSLSSSSSSSSSSLSLSSSWW",
"SSSSSSSSSSSSSSSLSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSLSSSSSLSSBSSWW",
"SSBSSSSLSLSSSBSSSSSSWW",
"SSSSSSSSLSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSLSSSWW",
"SLSSSBSSSSSSSSSLSLSSWW",
"LSLSSSSSSSSLSSSSLSSSWW",
"SLSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSLSSSSSSSSSSSWW",
"SLSLSSSLSLSSSSSLSSSSWW",
"SSSSSSSSLSSSSSBSSSSSWW",
"SSSBSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSSLSSWW",
"SSSLSSSSSSSLSSSSLSLSWW",
"SSLSLSSSSSSSSSSSSLSSWW",
"SSSLSSSSSSSLSSSSSSSSWW",
"SSSSSSSSSSLSLSSSLSSSWW",
"SSSLSSBSSSSLSSSSSSSSWW",
"SBSSSSSSSSSSSSSSSBSSWW",
"SSSSSLSSSSSSSSSSBSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SLSSSSSLSSSSSLSSSSSSWW",
"LSLSSSSSSSLSSSSBSSSSWW",
"SLSSSSLSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSLSSSSLSSWW",
"LSSSSSSSSSSSSSSSSSSSWW",
"SSSBSSSSSSSLSSSSSSLSWW",
"SSSSSLSSSSSSSSSBSSSSWW",
"SLSSSSSSSSSSSSSSSSSSWW",
"SSSSSSBSSSLSSSSSLSSSWW",
"SSSSLSSSSSSSSSSSSSSSWW",
"SSSSSSSLSSSSSLSSSSSSWW",
"SBSSSSSSSSSSSSSSBSSSWW",
"SSSSSSSLSSSSSSSSSSSSWW",
"SBSSSSLSSSSSSSSLSSSSWW",
"SSSSSSSSSSBSSSSSSSSSWW",
"LSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSBSLSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SLSSSSSSSSSSLSSSSSSSWW",
"SSSSSSSSSSSSSSSSSSLSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSLSSSSSSSSBSSSSWW",
"SSSSLSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSLSSSSWW",
"BSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"LSSSSSSSSLSSSSSSSSSSWW",
"SSSSSSSSSSSSSLSSSSSSWW",
"SSLSSLSSSSSSSSSSBSSSWW",
"SSSSSSSSSBSSSSSSSSSSWW",
"SSSSSSSSSSBSSSSSLSSSWW",
"SLSSSSLSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSBSSSSWW",
"SSSSSLSSSSSSSSSSLSSSWW",
"SSSBSSSSSSSLSSSSSSSSWW",
"SSSSSSLSSSSSLSSSBSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSLSSSSSLSSSSBSSLSWW",
"SSSSSSSSSLSSSSSSSSSSWW",
"LSSBSSSSLSSSLSSSSSSSWW",
"SSSSSSSSSSSSSSSLSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSLSSSSSSLSSSSSSSSSWW",
"SSSSSSSSSSSSSSBSLSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSSBSLWW",
"LSSSLSSSSSSSSSSSSSSLWW",
"SSLSSSSSSSSSSSSSSBSLWW",
"SLSLSSSSSSSSSSSSSSSLWW",
"SSLSSSSSSSSSSSSSSBSLWW",
"LSSSLSSSSSSSSSSSSSSLWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SLSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSSSSSSSSSSSSSSWW",
"SLSSSSSSSSSSSSSSSSSSWW",
"SSSSSSSS